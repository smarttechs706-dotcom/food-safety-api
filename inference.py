...
ae_model.load_state_dict(torch.load('/content/drive/MyDrive/autoencoder.pth', map_location=device))
ae_model.eval()

yolo_model = YOLO('/content/drive/MyDrive/yolov8n.pt')

xgb_v1 = joblib.load('/content/drive/MyDrive/xgb_model_v1.pkl')
xgb_v2 = joblib.load('/content/drive/MyDrive/xgb_model_v2.pkl')
